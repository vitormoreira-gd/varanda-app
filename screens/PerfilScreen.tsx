...
const styles = StyleSheet.create({
  ...
  topoTitulo: { fontSize: 20, fontWeight: '800', color: cores.primaria },
  ...
  email: { fontSize: 13, color: cores.textoFraco, marginTop: 2 },
  condominio: { fontSize: 12, color: cores.textoFraco, marginTop: 2 },
  etiquetas: { flexDirection: 'row', flexWrap: 'wrap', gap: espaco.sm, marginTop: espaco.lg },
  dica: { fontSize: 12, color: cores.textoFraco, lineHeight: 18, marginBottom: espaco.md },
  lista: { gap: espaco.sm },
  papel: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  papelIcone: { fontSize: 20 },
  papelRotulo: { fontSize: 14, fontWeight: '700', color: cores.texto },
  papelResumo: { fontSize: 12, color: cores.textoFraco, marginTop: 1 },
  aqui: { fontSize: 10, fontWeight: '700', color: cores.primaria, textTransform: 'uppercase' },
});
