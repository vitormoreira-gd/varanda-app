...
const styles = StyleSheet.create({
  ...
  numero: { flex: 1 },
  numeroValor: { fontSize: 22, fontWeight: '800', color: cores.texto },
  numeroDestaque: { color: cores.primaria, fontSize: 27 },
  numeroRotulo: { fontSize: 13, color: cores.textoFraco, marginTop: 2 },
  pendentes: { marginTop: espaco.md },
  dica: { fontSize: 13, color: cores.primaria, marginTop: espaco.md },
  unidade: { fontSize: 16, fontWeight: '800', color: cores.texto, marginBottom: espaco.sm },
  ninguem: { fontSize: 14, color: cores.perigo },
  morador: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: espaco.sm,
  ...
  nome: { fontSize: 15, color: cores.texto, fontWeight: '600', flexShrink: 1 },
  papel: { fontSize: 13, color: cores.textoFraco },
});
